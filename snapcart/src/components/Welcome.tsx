  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white">
      ...
      <motion.div
        ...
        className=" mt-7 flex flex-row gap-6"
      >
     ...
     initial={{
        ...
        className="mt-2 inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 cursor-pointer"
        onClick={()=>nextStep(2)}
     >
      Next <ArrowRight/>
     </motion.button>
