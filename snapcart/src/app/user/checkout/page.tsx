...
// ✅ Dynamically import MapContainer and related with ssr:false
...
const CheckOut = () => {
  ...
  // ✅ Marker icon created only on client when leaflet is loaded
  const markerIcon =
    leafletL
      ? new leafletL.Icon({
          iconUrl: "https://cdn-icons-png.flaticon.com/128/684/684908.png",
  ...
  // ✅ Inner map controller — only rendered client-side via isMounted guard
  const MapController = () => {
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* ✅ Map rendered only after client mount */}
            <div className="relative mt-6 h-[330px] rounded-xl overflow-hidden border border-gray-200 shadow-inner">
              {isMounted && position && markerIcon && (
                <MapContainer
                  center={position}
                  zoom={13}
                  scrollWheelZoom={true}
