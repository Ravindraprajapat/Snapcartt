  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-gradient-to-b from-green-50 to-white">
      ...
      <motion.p
        ...
        className="max-w-md text-gray-600 mt-2"
      >
      ...
      >
        <Link href="/user/my-orders">
          <div className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full shadow-lg transition-all">
      ...
      >
        ...
        <div className="absolute top-40 left-[70%] w-2 h-2 bg-green-400 rounded-full animate-pulse" />
      </motion.div>
