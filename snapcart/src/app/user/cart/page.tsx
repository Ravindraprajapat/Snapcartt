  ...
  return (
    <div className="w-[95%] sm:w-[90%] md:w-[80%] mx-auto mt-8 mb-24 relative">
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-3xl font-bold text-green-500 text-center mb-10"
      >
        🛒 Shopping Cart
      </motion.h2>
                ...
                >
                  <div className="relative w-28 h-28 sm:w-24 sm:h-24 md:w-28 md:h-28 flex-shrink-0 rounded-xl overflow-hidden bg-gray-50">
                    <Image
                      ...
                      alt={item.name}
                      fill
                      className="object-contain p-3 transition-transform duration-100 hover:scale-105"
                    />
                  </div>
                  ...
                  <button
                    ...
                    onClick={() => dispatch(removeFromItem(item._id))}
                  >
                    <Trash size={18} />
                  </button>
                </motion.div>
...
//             animate={{ opacity: 1, x: 0 }}
//             transition={{ duration: 0.3 }}
//             className="bh-white rounded-2xl shadow-xl p-6 h-fit sticky top-24 border border-gray-100 flex flex-col"
//           >
//             <h1 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">
//               Order Summary
//             </h1>
