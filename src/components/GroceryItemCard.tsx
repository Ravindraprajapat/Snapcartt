"use client";
import { addToCartData, decreaseQuantity, increaseQuantity } from "@/redux/cartSlice";
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {!cartItem ? (
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            onClick={() => dispatch(addToCartData({ ...item, quantity: 1 }))}
          >
          ...
          >
            ...
            className=" cursor-pointer w-7 h-7 flex items-center justify-center rounded-full bg-green-100 hover:bg-green-200 transition-all">
