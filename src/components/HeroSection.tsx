...
const HeroSection = () => {
  const slides = [
    ...
    },
    {
      ...
      btnText: "Order Now",
      bg: "https://images.unsplash.com/photo-1695654390723-479197a8c4a3?q=80&w=1134&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 3,
      icon: (
      ...
      btnText: "Get Started",
      bg: "https://media.istockphoto.com/id/2186420837/photo/happy-couple-choosing-oranges-in-reusable-mesh-bag-at-grocery-store.jpg?s=612x612&w=is&k=20&c=_uxvmRQOyIFtU33nnrSQd7J2QW86HSUlAoBJBPUOSYU=",
    },
  ];
